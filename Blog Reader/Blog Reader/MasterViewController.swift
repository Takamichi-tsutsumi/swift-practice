...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = NSURL(string: "https://www.googleapis.com/blogger/v3/blogs/20042392/posts?key=AIzaSyBFDV6TSMKFHPA994zDC9t-iKrfmiI3hLY")!
            ...
            if error != nil {
                ...
                if let data = data {
                    ...
                    do {
                        ...
                        print("JSON Serialization failled.")
